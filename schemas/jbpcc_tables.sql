...
INSERT INTO JBPCC_IDGEN (gen_name, gen_val) VALUES ('SERVERS_GEN', 10);
...
INSERT INTO JBPCC_SERVERS(ID, NAME, JMXAGENTNAME, IP, PORT)
VALUES(1, 'server1', 'agent1', 'localhost', 9999);

INSERT INTO JBPCC_SERVERS(ID, NAME, JMXAGENTNAME, IP, PORT)
VALUES(2, 'server2', 'agent2', 'localhost', 9988);

INSERT INTO JBPCC_USERSERVERS(USERID, SERVERID)
VALUES(1,1);
