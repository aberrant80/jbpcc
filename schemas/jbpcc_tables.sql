...
INSERT INTO JBPCC_USERS(ID, LOGINNAME, FORENAME, SURNAME,  PASSWORD) 
VALUES (2, 'james', 'Khoo', 'James', 'james');

INSERT INTO JBPCC_USERS(ID, LOGINNAME, FORENAME, SURNAME, ENABLED, PASSWORD) 
VALUES (3, 'joyce', 'JBPCC', 'Administrator', 'Yes', 'admin');

INSERT INTO JBPCC_USERS(ID, LOGINNAME, FORENAME, SURNAME, ENABLED, PASSWORD) 
VALUES (4, 'hong', 'JBPCC', 'Administrator', 'No', 'admin');

INSERT INTO JBPCC_USERS(ID, LOGINNAME, FORENAME, SURNAME, ENABLED, PASSWORD) 
VALUES (5, 'wong', 'JBPCC', 'Administrator', 'Yes', 'admin');

INSERT INTO JBPCC_USERS(ID, LOGINNAME, FORENAME, SURNAME, ENABLED, PASSWORD) 
VALUES (6, 'tan', 'JBPCC', 'Administrator', 'No', 'admin');

INSERT INTO JBPCC_USERS(ID, LOGINNAME, FORENAME, SURNAME, ENABLED, PASSWORD) 
VALUES (7, 'fong', 'JBPCC', 'Administrator', 'No', 'admin');

INSERT INTO JBPCC_USERS(ID, LOGINNAME, FORENAME, SURNAME, ENABLED, PASSWORD) 
VALUES (8, 'foo', 'JBPCC', 'Administrator', 'Yes', 'admin');
